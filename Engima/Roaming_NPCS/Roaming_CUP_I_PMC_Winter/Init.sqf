call compile preprocessFileLineNumbers "Engima\Roaming_NPCS\Common\Common.sqf";
call compile preprocessFileLineNumbers "Engima\Roaming_NPCS\Common\Debug.sqf";
...
if (isServer) then {
	call compile preprocessFileLineNumbers "Engima\Roaming_NPCS\Server\ServerFunctions.sqf";
	call compile preprocessFileLineNumbers "Engima\Roaming_NPCS\Roaming_CUP_I_PMC_Winter\ConfigAndStart.sqf";
};
