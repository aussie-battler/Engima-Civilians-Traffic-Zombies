...
ENGIMA_CIVILIANS_MINSKILL = 1;       // If you spawn something other than civilians, you may want to set another skill level of the spawned units.
...
ENGIMA_CIVILIANS_RUNNINGCHANCE = 0.10; // Chance of running instead of walking
...
if (isServer) then {
	...
	call compile preprocessFileLineNumbers "Engima\AmbientLife\ConfigAndStart.sqf";
};
